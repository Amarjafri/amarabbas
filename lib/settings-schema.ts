...
export const SETTING_TABS: SettingTab[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      f('hero_title', 'Headline', 'rich', 'Wrap the closing phrase in <em>…</em> to give it the animated gradient.'),
      f('hero_rotate_words', 'Typing Words', 'textarea', 'One per line. The line under the headline types these out in turn.'),
      f('hero_desc', 'Intro Paragraph', 'rich', '<strong>…</strong> is allowed for emphasis.'),
      f('hero_btn1_label', 'Primary Button Label', 'text', 'Scrolls down to the Selected Work section. The arrow is added automatically.'),
      f('hero_btn2_label', 'CV Link Label', 'text', 'Downloads the CV file set under Profile. Shown as a text link.'),
      f('hero_btn3_label', 'Contact Link Label', 'text', 'Optional link to the contact section. Leave empty to hide.'),
  ...
  },
  {
    ...
    fields: [
      ...
      f('projects_limit', 'Projects — How many', 'number', 'Featured projects on the homepage. The first four are shown as large blocks, the rest under More Work.'),
